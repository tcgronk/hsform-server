...
// ===============================================
var RedirectsApiApiKeys;
(function (RedirectsApiApiKeys) {
    RedirectsApiApiKeys[RedirectsApiApiKeys["hapikey"] = 0] = "hapikey";
})(RedirectsApiApiKeys = exports.RedirectsApiApiKeys || (exports.RedirectsApiApiKeys = {}));
class RedirectsApi {
    ...
    setApiKey(key, value) {
        this.authentications[RedirectsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    archive(urlRedirectId, options = { headers: {} }) {
     ...
     */
    create(urlMappingCreateRequestBody, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(urlMappingCreateRequestBody, "UrlMappingCreateRequestBody")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
                    ...
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 201) {
                                body = models_1.ObjectSerializer.deserialize(body, "UrlMapping");
                            }
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body });
                            }
     ...
     * @param urlRedirectId The ID of the target redirect.
     */
    getById(urlRedirectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/url-redirects/{urlRedirectId}'
                .replace('{' + 'urlRedirectId' + '}', encodeURIComponent(String(urlRedirectId)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 200) {
                                body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseWithTotalUrlMapping");
                            }
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body });
                            }
     ...
     * @param urlMapping
     */
    update(urlRedirectId, urlMapping, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/url-redirects/{urlRedirectId}'
                .replace('{' + 'urlRedirectId' + '}', encodeURIComponent(String(urlRedirectId)));
            let localVarQueryParameters = {};
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(urlMapping, "UrlMapping")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
