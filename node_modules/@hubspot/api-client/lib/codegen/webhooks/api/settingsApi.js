...
(function (SettingsApiApiKeys) {
    SettingsApiApiKeys[SettingsApiApiKeys["developer_hapikey"] = 0] = "developer_hapikey";
...
class SettingsApi {
     ...
     */
    configure(appId, settingsChangeRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/webhooks/v3/{appId}/settings'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
            let localVarQueryParameters = {};
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(settingsChangeRequest, "SettingsChangeRequest")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.developer_hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.developer_hapikey.applyToRequest(localVarRequestOptions));
