...
export declare class TemplatesApi {
     ...
     */
    archiveEventTemplate(eventTemplateId: string, appId: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createEventTemplate(appId: object, timelineEventTemplateCreateRequest?: TimelineEventTemplateCreateRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param appId The ID of the target app.
     */
    getAllEventTemplates(appId: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param appId The ID of the target app.
     */
    getEventTemplateById(eventTemplateId: string, appId: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    updateEventTemplate(eventTemplateId: string, appId: object, timelineEventTemplateUpdateRequest?: TimelineEventTemplateUpdateRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
