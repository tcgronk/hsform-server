...
(function (TokensApiApiKeys) {
    TokensApiApiKeys[TokensApiApiKeys["hapikey"] = 0] = "hapikey";
...
class TokensApi {
     ...
     */
    archiveEventTemplateToken(eventTemplateId, tokenName, appId, options = { headers: {} }) {
     ...
     */
    createEventTemplateToken(eventTemplateId, appId, timelineEventTemplateToken, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    updateEventTemplateToken(eventTemplateId, tokenName, appId, timelineEventTemplateTokenUpdateRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/timeline/{appId}/event-templates/{eventTemplateId}/tokens/{tokenName}'
                .replace('{' + 'eventTemplateId' + '}', encodeURIComponent(String(eventTemplateId)))
                .replace('{' + 'tokenName' + '}', encodeURIComponent(String(tokenName)))
