...
export declare class TokensApi {
     ...
     */
    archiveEventTemplateToken(eventTemplateId: string, tokenName: string, appId: object, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createEventTemplateToken(eventTemplateId: string, appId: object, timelineEventTemplateToken?: TimelineEventTemplateToken, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: TimelineEventTemplateToken;
    }>;
    /**
     ...
     */
    updateEventTemplateToken(eventTemplateId: string, tokenName: string, appId: object, timelineEventTemplateTokenUpdateRequest?: TimelineEventTemplateTokenUpdateRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
