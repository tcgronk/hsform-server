...
export declare class EventsApi {
     ...
     */
    getById(eventTemplateId: number, eventId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param eventId The event ID.
     */
    getDetailById(eventTemplateId: number, eventId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getRenderById(eventTemplateId: number, eventId: string, detail?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
