...
(function (TypesApiApiKeys) {
    TypesApiApiKeys[TypesApiApiKeys["hapikey"] = 0] = "hapikey";
...
class TypesApi {
     ...
     * @param toObjectType
     */
    getAll(fromObjectType, toObjectType, options = { headers: {} }) {
                    ...
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 200) {
                                body = models_1.ObjectSerializer.deserialize(body, "CollectionResponsePublicAssociationDefiniton");
                            }
