...
// ===============================================
var PipelinesApiApiKeys;
(function (PipelinesApiApiKeys) {
    PipelinesApiApiKeys[PipelinesApiApiKeys["hapikey"] = 0] = "hapikey";
})(PipelinesApiApiKeys = exports.PipelinesApiApiKeys || (exports.PipelinesApiApiKeys = {}));
class PipelinesApi {
    ...
    setApiKey(key, value) {
        this.authentications[PipelinesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param pipelineId
     */
    archive(objectType, pipelineId, options = { headers: {} }) {
     ...
     * @param pipelineInput
     */
    create(objectType, pipelineInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(pipelineInput, "PipelineInput")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
     ...
     */
    getAll(objectType, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/pipelines/{objectType}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
            let localVarQueryParameters = {};
                    ...
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 200) {
                                body = models_1.ObjectSerializer.deserialize(body, "CollectionResponsePipeline");
                            }
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body });
                            }
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getById(objectType, pipelineId, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/pipelines/{objectType}/{pipelineId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
     ...
     * @param pipelineInput
     */
    replace(objectType, pipelineId, pipelineInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/pipelines/{objectType}/{pipelineId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
     ...
     */
    update(objectType, pipelineId, archived, pipelinePatchInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/pipelines/{objectType}/{pipelineId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(pipelinePatchInput, "PipelinePatchInput")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
