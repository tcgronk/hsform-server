...
export declare class BasicApi {
    ...
    /**
     * Create a company with the given properties and return a copy of the object, including the ID. Documentation and examples for creating native companies is provided.
     * @summary Create
     ...
     */
    getById(companyId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
