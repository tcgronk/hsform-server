...
class BasicApi {
    ...
    /**
     * Create a product with the given properties and return a copy of the object, including the ID. Documentation and examples for creating native products is provided.
     * @summary Create
     ...
     */
    getById(productId, properties, associations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/products/{productId}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)));
            let localVarQueryParameters = {};
