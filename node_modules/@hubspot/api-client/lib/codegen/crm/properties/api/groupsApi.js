...
(function (GroupsApiApiKeys) {
    GroupsApiApiKeys[GroupsApiApiKeys["hapikey"] = 0] = "hapikey";
...
class GroupsApi {
     ...
     * @param groupName
     */
    archive(objectType, groupName, options = { headers: {} }) {
     ...
     */
    create(objectType, propertyGroupCreate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(propertyGroupCreate, "PropertyGroupCreate")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
                    ...
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 201) {
                                body = models_1.ObjectSerializer.deserialize(body, "PropertyGroup");
                            }
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body });
                            }
     ...
     * @param objectType
     */
    getAll(objectType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/properties/{objectType}/groups'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
            let localVarQueryParameters = {};
                    ...
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 200) {
                                body = models_1.ObjectSerializer.deserialize(body, "CollectionResponsePropertyGroup");
                            }
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body });
                            }
     ...
     * @param groupName
     */
    getByName(objectType, groupName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/properties/{objectType}/groups/{groupName}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)));
     ...
     */
    update(objectType, groupName, propertyGroupUpdate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/properties/{objectType}/groups/{groupName}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)));
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(propertyGroupUpdate, "PropertyGroupUpdate")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
