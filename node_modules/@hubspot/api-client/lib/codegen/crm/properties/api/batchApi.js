...
class BatchApi {
     ...
     */
    archive(objectType, batchInputPropertyName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputPropertyName === null || batchInputPropertyName === undefined) {
                throw new Error('Required parameter batchInputPropertyName was null or undefined when calling archive.');
            }
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(batchInputPropertyName, "BatchInputPropertyName")
            };
     ...
     */
    create(objectType, batchInputPropertyCreate, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputPropertyCreate === null || batchInputPropertyCreate === undefined) {
                throw new Error('Required parameter batchInputPropertyCreate was null or undefined when calling create.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(batchInputPropertyCreate, "BatchInputPropertyCreate")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
                    ...
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode === 201) {
                                body = models_1.ObjectSerializer.deserialize(body, "BatchResponseProperty");
                            }
     ...
     */
    read(objectType, batchReadInputPropertyName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchReadInputPropertyName === null || batchReadInputPropertyName === undefined) {
                throw new Error('Required parameter batchReadInputPropertyName was null or undefined when calling read.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(batchReadInputPropertyName, "BatchReadInputPropertyName")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
