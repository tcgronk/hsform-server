...
class StringPropertyVariable {
    static getAttributeTypeMap() {
        return StringPropertyVariable.attributeTypeMap;
    }
}
exports.StringPropertyVariable = StringPropertyVariable;
StringPropertyVariable.discriminator = undefined;
StringPropertyVariable.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
        "type": "StringPropertyVariable.OperatorEnum"
    },
    {
        "name": "value",
        "baseName": "value",
...
(function (StringPropertyVariable) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["STRINGPROPERTYVARIABLE"] = 'STRING_PROPERTY_VARIABLE'] = "STRINGPROPERTYVARIABLE";
    })(OperatorEnum = StringPropertyVariable.OperatorEnum || (StringPropertyVariable.OperatorEnum = {}));
})(StringPropertyVariable = exports.StringPropertyVariable || (exports.StringPropertyVariable = {}));
