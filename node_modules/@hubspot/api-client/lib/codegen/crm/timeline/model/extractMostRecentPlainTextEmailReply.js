...
class ExtractMostRecentPlainTextEmailReply {
    static getAttributeTypeMap() {
        return ExtractMostRecentPlainTextEmailReply.attributeTypeMap;
    }
}
exports.ExtractMostRecentPlainTextEmailReply = ExtractMostRecentPlainTextEmailReply;
ExtractMostRecentPlainTextEmailReply.discriminator = undefined;
ExtractMostRecentPlainTextEmailReply.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
        "type": "ExtractMostRecentPlainTextEmailReply.OperatorEnum"
    },
    {
        "name": "value",
        "baseName": "value",
...
(function (ExtractMostRecentPlainTextEmailReply) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["EXTRACTMOSTRECENTPLAINTEXTEMAILREPLY"] = 'EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY'] = "EXTRACTMOSTRECENTPLAINTEXTEMAILREPLY";
    })(OperatorEnum = ExtractMostRecentPlainTextEmailReply.OperatorEnum || (ExtractMostRecentPlainTextEmailReply.OperatorEnum = {}));
})(ExtractMostRecentPlainTextEmailReply = exports.ExtractMostRecentPlainTextEmailReply || (exports.ExtractMostRecentPlainTextEmailReply = {}));
