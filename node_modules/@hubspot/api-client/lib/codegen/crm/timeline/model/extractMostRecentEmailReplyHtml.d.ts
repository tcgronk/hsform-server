...
export declare class ExtractMostRecentEmailReplyHtml {
    'operator': ExtractMostRecentEmailReplyHtml.OperatorEnum;
    'value'?: string;
...
export declare namespace ExtractMostRecentEmailReplyHtml {
    enum OperatorEnum {
