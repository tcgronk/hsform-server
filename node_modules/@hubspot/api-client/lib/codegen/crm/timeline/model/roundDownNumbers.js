...
class RoundDownNumbers {
    static getAttributeTypeMap() {
        return RoundDownNumbers.attributeTypeMap;
    }
}
exports.RoundDownNumbers = RoundDownNumbers;
RoundDownNumbers.discriminator = undefined;
RoundDownNumbers.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
        "type": "RoundDownNumbers.OperatorEnum"
    },
    {
        "name": "value",
        "baseName": "value",
...
(function (RoundDownNumbers) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["ROUNDDOWN"] = 'ROUND_DOWN'] = "ROUNDDOWN";
    })(OperatorEnum = RoundDownNumbers.OperatorEnum || (RoundDownNumbers.OperatorEnum = {}));
})(RoundDownNumbers = exports.RoundDownNumbers || (exports.RoundDownNumbers = {}));
