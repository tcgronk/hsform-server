...
export declare class ExtractMostRecentPlainTextEmailReply {
    'operator': ExtractMostRecentPlainTextEmailReply.OperatorEnum;
    'value'?: string;
...
export declare namespace ExtractMostRecentPlainTextEmailReply {
    enum OperatorEnum {
        EXTRACTMOSTRECENTPLAINTEXTEMAILREPLY
    }
}
