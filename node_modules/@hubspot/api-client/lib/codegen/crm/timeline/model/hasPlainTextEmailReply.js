...
class HasPlainTextEmailReply {
    static getAttributeTypeMap() {
        return HasPlainTextEmailReply.attributeTypeMap;
    }
}
exports.HasPlainTextEmailReply = HasPlainTextEmailReply;
HasPlainTextEmailReply.discriminator = undefined;
HasPlainTextEmailReply.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
...
(function (HasPlainTextEmailReply) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["HASPLAINTEXTEMAILREPLY"] = 'HAS_PLAIN_TEXT_EMAIL_REPLY'] = "HASPLAINTEXTEMAILREPLY";
    })(OperatorEnum = HasPlainTextEmailReply.OperatorEnum || (HasPlainTextEmailReply.OperatorEnum = {}));
})(HasPlainTextEmailReply = exports.HasPlainTextEmailReply || (exports.HasPlainTextEmailReply = {}));
