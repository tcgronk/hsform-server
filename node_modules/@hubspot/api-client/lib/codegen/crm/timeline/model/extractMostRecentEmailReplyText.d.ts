...
export declare class ExtractMostRecentEmailReplyText {
    'operator': ExtractMostRecentEmailReplyText.OperatorEnum;
    'value'?: string;
...
export declare namespace ExtractMostRecentEmailReplyText {
    enum OperatorEnum {
        EXTRACTMOSTRECENTEMAILREPLYTEXT
    }
}
