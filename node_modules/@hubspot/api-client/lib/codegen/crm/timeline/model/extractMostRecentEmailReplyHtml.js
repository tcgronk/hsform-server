...
class ExtractMostRecentEmailReplyHtml {
    static getAttributeTypeMap() {
        return ExtractMostRecentEmailReplyHtml.attributeTypeMap;
    }
}
exports.ExtractMostRecentEmailReplyHtml = ExtractMostRecentEmailReplyHtml;
ExtractMostRecentEmailReplyHtml.discriminator = undefined;
ExtractMostRecentEmailReplyHtml.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
        "type": "ExtractMostRecentEmailReplyHtml.OperatorEnum"
    },
    {
        "name": "value",
        "baseName": "value",
...
(function (ExtractMostRecentEmailReplyHtml) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["EXTRACTMOSTRECENTEMAILREPLYHTML"] = 'EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML'] = "EXTRACTMOSTRECENTEMAILREPLYHTML";
    })(OperatorEnum = ExtractMostRecentEmailReplyHtml.OperatorEnum || (ExtractMostRecentEmailReplyHtml.OperatorEnum = {}));
})(ExtractMostRecentEmailReplyHtml = exports.ExtractMostRecentEmailReplyHtml || (exports.ExtractMostRecentEmailReplyHtml = {}));
