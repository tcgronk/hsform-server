...
class BooleanPropertyVariable {
    static getAttributeTypeMap() {
        return BooleanPropertyVariable.attributeTypeMap;
    }
}
exports.BooleanPropertyVariable = BooleanPropertyVariable;
BooleanPropertyVariable.discriminator = undefined;
BooleanPropertyVariable.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
...
(function (BooleanPropertyVariable) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["BOOLEANPROPERTYVARIABLE"] = 'BOOLEAN_PROPERTY_VARIABLE'] = "BOOLEANPROPERTYVARIABLE";
    })(OperatorEnum = BooleanPropertyVariable.OperatorEnum || (BooleanPropertyVariable.OperatorEnum = {}));
})(BooleanPropertyVariable = exports.BooleanPropertyVariable || (exports.BooleanPropertyVariable = {}));
