...
class NumberPropertyVariable {
    static getAttributeTypeMap() {
        return NumberPropertyVariable.attributeTypeMap;
    }
}
exports.NumberPropertyVariable = NumberPropertyVariable;
NumberPropertyVariable.discriminator = undefined;
NumberPropertyVariable.attributeTypeMap = [
    {
        "name": "operator",
        "baseName": "operator",
        "type": "NumberPropertyVariable.OperatorEnum"
    },
    {
        "name": "value",
        "baseName": "value",
...
(function (NumberPropertyVariable) {
    let OperatorEnum;
    (function (OperatorEnum) {
        OperatorEnum[OperatorEnum["NUMBERPROPERTYVARIABLE"] = 'NUMBER_PROPERTY_VARIABLE'] = "NUMBERPROPERTYVARIABLE";
    })(OperatorEnum = NumberPropertyVariable.OperatorEnum || (NumberPropertyVariable.OperatorEnum = {}));
})(NumberPropertyVariable = exports.NumberPropertyVariable || (exports.NumberPropertyVariable = {}));
