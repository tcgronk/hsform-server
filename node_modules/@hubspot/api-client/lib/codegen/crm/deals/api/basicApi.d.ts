...
export declare class BasicApi {
    ...
    /**
     * Create a deal with the given properties and return a copy of the object, including the ID. Documentation and examples for creating native deals is provided.
     * @summary Create
     ...
     */
    getById(dealId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
